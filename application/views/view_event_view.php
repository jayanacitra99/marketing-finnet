<div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="<?php echo base_url();?>index.php/main/add_event" class="btn btn-primary"><i class="fa fa-plus fa-fw"></i>Tambah Event</a>
                    <a href="<?php echo base_url();?>index.php/excel_export/action_event" class="nav-link js-scroll-trigger btn btn-success"><i class="fa fa-file-excel-o fa-fw"></i>Export to Excel</a>
                </div>
            </div>
            <br>
            <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>';
                                                if ($data->status == 'DONE'){
                                                    ...
                                                    echo '<a href="'.base_url().'index.php/main/edit_event/'.$data->id_event.'" class="btn btn-info"><i class="glyphicon glyphicon-edit"></i>Done</a>';
                                                }
                                            '</td>
                                        </tr>';
                                    $no++;
