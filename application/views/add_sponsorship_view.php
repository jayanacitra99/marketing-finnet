            ...
            <form method="post" action="<?php echo base_url();?>index.php/main/new_sponsorship">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sponsorship - New Sponsorship</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <a href="<?php echo base_url();?>index.php/main/sponsorship" class="btn btn-primary"><i class="fa fa-table fa-fw"></i>View Sponsorship</a>
                    <br>
                    <br>
